...
/**
 The `SCHTTPExecutor` class is a request executor and queue manager that takes `<SCHTTPRequest>` instances and translates
 ...
 you can safely perform all sorts of requests to different hosts under the same `SCHTTPExecutor` instance.
 */
@interface SCHTTPExecutor : NSObject
...
/**
 ...
 @return An initialized `SCHTTPExecutor` with a unique *identifier*.
 */
- (instancetype)initWithId:(NSString*)identifier;

/**
 Returns a singleton `SCHTTPExecutor`
 
 @return A `SCHTTPExecutor` singleton.
 */
