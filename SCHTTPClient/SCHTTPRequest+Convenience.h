...
@interface SCHTTPRequest (Convenience)
...
/**
 ...
 This method assigns a `<SCHTTPAccumulator>` as the `<responseContentHandler>` for this request.
 */
...
/**
 ...
 This method assigns a `<SCHTTPToStringConverter>` as the `<responseContentHandler>` for this request.
 */
...
/**
 ...
 This method assigns a `<SCJSONParser>` as the `<responseContentHandler>` for this request.
 */
...
/**
 ...
 This method assigns a `<SCHTTPImageDecoder>` as the `<responseContentHandler>` for this request.
 */
...
/**
 ...
 This method assigns a `<SCHTTPFileWriter>` as the `<responseContentHandler>` for this request.
...
/**
 ...
 This method assigns a `<SCHTTPStreamWriter>` as the `<responseContentHandler>` for this request.
...
/**
 ...
 Sets `<responseContentHandler>` to `<[SCHTTPSelectiveDiscarder sharedDiscarder]>`.
 */
...
/**
 Convenience method that executes this request in the singleton instance of `<SCHTTPExecutor>`.

 @param completed The completed block that will be called when the request terminates normally.
