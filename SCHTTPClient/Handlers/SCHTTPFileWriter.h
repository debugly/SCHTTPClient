...
/**
 Response parser that inherits selective behavior from `<SCHTTPSelectiveResponseParser>` and dumps all the data it
 ...
 */
@interface SCHTTPFileWriter : SCHTTPSelectiveDiscarder
