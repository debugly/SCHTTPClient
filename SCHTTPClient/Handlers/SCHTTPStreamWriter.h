...
/**
 Response parser that inherits selective behavior from `<SCHTTPSelectiveResponseParser>` and pumps all the data it
 ...
 */
@interface SCHTTPStreamWriter : SCHTTPSelectiveDiscarder
